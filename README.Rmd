...
`embed` is a package that contains extra steps for the [`recipes`](https://recipes.tidymodels.org/) package for embedding predictors into one or more numeric columns. Almost all of the preprocessing methods are _supervised_. 
...
Note that, to use some steps, you will also have to load other packages such as `rstanarm` and `lme4`. For all of the steps to work, you may want to use: 
